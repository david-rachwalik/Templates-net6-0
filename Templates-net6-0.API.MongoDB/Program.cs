...
using Templates_net6_0.API.MongoDB.Data;
...
//    new MongoClient(builder.Configuration.GetValue<string>("StudentsStoreDatabaseSettings:ConnectionString")));
builder.Services.AddSingleton<IMongoClient>(s => new MongoClient());

builder.Services.AddScoped<IStudentService, StudentService>();

// --- Continue with usual middleware ---
